    ...
    <div class="container">
      <div class="mt-5">
          ...
          <div class="col-12 col-md-6">
            <div class="d-flex">
              ...
              <div class="close-icon">
                  <svg v-if="keyword" class="cursor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none">
        ...
        <!-- end search box -->
          ...
          <div v-if="locationSuggests && locationSuggests.length > 0" class="row d-flex justify-content-center mt-3">
