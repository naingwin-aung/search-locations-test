...
const postHandler = async () => {
    postLoading.value = true;
    locationSuggests.value = [];
    const res = await axios.post(`https://mab.mabsayyaungchelrun.com/wp-json/dd_mab/v1/search?lang=${lang.value}&post_type=${postParams.post_type}&taxo_name=${postParams.taxo_name}&search_key=${keyword.value}&paged=${page.value}`);
                    ...
                    <div class="d-flex position-relative w-50">
                        ...
                        <div class="search-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <mask id="mask0_6977_3084" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="24" height="24">
                        ...
                        <div class="close-icon">
                            <svg @click="clearHandler" v-if="keyword" class="cursor" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <mask id="mask0_6977_3087" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="24" height="24">
                                    <rect width="24" height="24" fill="#D9D9D9" />
                                </mask>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="card-box">
                            ...
                            <div class="d-flex gap-4 justify-content-center p-2">
                                <div v-for="(taxo_name, postType) in postTypes" :key="taxo_name"
                                    class="d-flex align-items-center">
                                    <input type="radio" :id="postType" name="post_type" :value="taxo_name.tax"
                                        :checked="taxo_name.tax === postParams.taxo_name"
                                        @input="getPostTypeAndTaxoName(postType, taxo_name.tax)"
                                        class="cursor post-type-radio">
                        ...
                        <div class="post-table-wrapper">
                            <div class="d-flex justify-content-around align-items-center">
                                <h4 class="cursor flex-fill d-flex justify-content-center post-list-view"
                                    :class="[{ 'view-active': defaultView == 'listView' }]"
                                    @click="changeViewHandler('listView')">
                                ...
                                <h4 class="cursor flex-fill d-flex justify-content-center post-list-view"
                                    :class="[{ 'view-active': defaultView == 'mapView' }]"
                                    @click="changeViewHandler('mapView')">
                                    <div class="d-flex align-items-center gap-2">
                                            ...
                                            <button class="btn-post-direction">
                                                <div class="d-flex align-items-center gap-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                                        ...
                                                        <mask id="mask0_3653_21831" style="mask-type:alpha"
